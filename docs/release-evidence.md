...
Version 1.0.8 is the current completed release lineage. Audited source `fc2957843077606a1cdb8fe9101cbed9421fb243` intentionally omits `public/security/release-summary.json`. Direct child `1c1c06b8e5c6973604b025b63aafed606b2bd522` adds only that generated file; annotated tag `v1.0.8` points to the child, and the same child is deployed. The hosted [release summary](https://tylerwilhite.dev/security/release-summary.json) and [deployment binding](https://tylerwilhite.dev/security/deployment-binding.json) record that exact Production relation for `https://tylerwilhite.dev`, including the Workbench at `/workbench/`.
