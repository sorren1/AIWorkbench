...
| 2:50–3:25 | [5 · Sandbox replay](../demo/?walkthrough=principal&tourStep=sandbox-replay&screen=trace&traceFocus=run)                                      | Read run ID, provider, exact source commit, tested-tree digest, and browser boundary.                                                                                                                                                                                                           | This is validated recorded evidence from a real local Docker run over synthetic inputs, not live visitor execution. The source working tree is explicitly labeled `CLEAN`; the separately recorded tested-tree digest identifies the controlled patched fixture.                          |
