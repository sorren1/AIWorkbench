...
| Sandbox evidence               | `npm run sandbox:evidence:validate`                                          | PASS — two regenerated post-rewrite packs are valid; the latest successful digest is `f3e9eab160e884695df71e4f218730e5932fbab39cbd8768b6ca4e15b1876c77`.        |
