...
- replaced the provider wildcard Workbench rewrite with exact page-to-file rewrites and corrected Vercel's named wildcard syntax for immutable assets, so hosted subroutes resolve directly and hashed CSS/JavaScript retain their intended cache policy.
